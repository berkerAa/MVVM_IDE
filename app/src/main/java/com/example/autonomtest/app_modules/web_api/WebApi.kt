...
interface WebApi {
	...
	fun verifyCode(@Body verifyCodeModel: VerifyCodeModel): Observable<BaseResponse>
	fun welcomescreen(@Body welcomeScreenModel: WelcomeScreenModel): Observable<BaseResponse>
